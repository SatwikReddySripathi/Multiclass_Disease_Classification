...
def grid_search():
    ...
    for params in all_combinations:
        ...
        with mlflow.start_run():
            ...
            train_loader, val_loader, test_loader = load_data_from_gcs(
                config["bucket_name"], config["file_name"], batch_size, config["train_percent"], config["val_percent"]
            )
...
if __name__ == "__main__":
    config = {
        ...
        "file_name": "Data_Preprocessing_files/preprocessed_data.pkl",
        "num_demographics": 3,
        "num_classes": 15,
        "train_percent": 0.7,
        "val_percent": 0.1
